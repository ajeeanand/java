...
//
//
//        if ((max_profit == profit_1 && max_profit == profit_2) || (max_profit == profit_1 && max_profit == profit_a) || (max_profit == profit_1 && max_profit == profit_b) || (max_profit == profit_1 && max_profit == profit_c)) {
//            return "-1";
//        } else if (max_profit == profit_1) {
//            return String.format("%.2f", max_profit) + "," + String.format("%.2f", x1) + "," + String.format("%.2f", y1);
//        }
//
//        if ((max_profit == profit_2 && max_profit == profit_1) || (max_profit == profit_2 && max_profit == profit_a) || (max_profit == profit_2 && max_profit == profit_b) || (max_profit == profit_2 && max_profit == profit_c)) {
//            return "-1";
//        } else if (max_profit == profit_2) {
//            return String.format("%.2f", max_profit) + "," + String.format("%.2f", x2) + "," + String.format("%.2f", y2);
//        }
//
//        if ((max_profit == profit_a && max_profit == profit_1) || (max_profit == profit_a && max_profit == profit_2) || (max_profit == profit_a && max_profit == profit_b) || (max_profit == profit_a && max_profit == profit_c)) {
//            return "-1";
//        } else if (max_profit == profit_a) {
//            return String.format("%.2f", max_profit) + "," + String.format("%.2f", xa) + "," + String.format("%.2f", ya);
//        }
//
//        if ((max_profit == profit_b && max_profit == profit_1) || (max_profit == profit_b && max_profit == profit_2) || (max_profit == profit_b && max_profit == profit_a) || (max_profit == profit_b && max_profit == profit_c)) {
//            return "-1";
//        } else if (max_profit == profit_b) {
//            return String.format("%.2f", max_profit) + "," + String.format("%.2f", xb) + "," + String.format("%.2f", yb);
//        }
//
//        if ((max_profit == profit_c && max_profit == profit_1) || (max_profit == profit_c && max_profit == profit_2) || (max_profit == profit_c && max_profit == profit_a) || (max_profit == profit_c && max_profit == profit_b)) {
//            return "-1";
//        } else if (max_profit == profit_c) {
